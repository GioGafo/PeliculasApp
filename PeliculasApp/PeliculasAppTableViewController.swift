...
class PeliculasAppTableViewController: UITableViewController {
    ...
    private func llenarDatos(){
        ...
        let imagen1 = UIImage(named: "1")
        let imagen2 = UIImage(named: "2")
        let imagen3 = UIImage(named: "3")
        
        guard let pelicula1 = Pelicula(nombre: "Infinity War", compania:"Marvel", foto:imagen1, rating:4) else {
            fatalError("Error al crear el objeto")
        }
        
        guard let pelicula2 = Pelicula(nombre: "Deadpool 2", compania:"Marvel", foto:imagen2, rating:4) else {
            fatalError("Error al crear el objeto")
        }
        
        guard let pelicula3 = Pelicula(nombre: "Guardianes de la Galaxia Vol.2", compania:"Marvel", foto:imagen3, rating:4) else {
            fatalError("Error al crear el objeto")
        }
